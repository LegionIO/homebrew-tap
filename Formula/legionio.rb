class Legionio < Formula
  ...
  on_arm do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.1-1/legion-1.9.1-1-darwin-arm64.tar.gz"
    sha256 "3085a2545dab6f7d51298c0bf7bf2deff7ed0bc055f54d920a1e02952009c13b"
  end

  on_intel do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.1-1/legion-1.9.1-1-darwin-x86_64.tar.gz"
    sha256 "54624b5290635175d2ae7c1502756f7f2667ca48c044a151fe7a4f70ade6a7a1"
  end
  ...
  bottle do
    root_url "https://github.com/LegionIO/homebrew-tap/releases/download/bottles-legionio-1.9.0-1"
    sha256 cellar: :any, arm64_sequoia: "b6781b4fde83084cfc59698a0b38158716dcb070d1853c41e1fa1f46f2fe7ea3"
    sha256 cellar: :any, arm64_sonoma: "68bff46acb74de45b6fdb8d9baf693628c9d01cf5b07e5e9a218cd34ee214543"
    sha256 cellar: :any, sequoia: "8e0d5e7554b992ea1c1cca13c793ddae189020b684780456dc1a705c4553a191"
  end
