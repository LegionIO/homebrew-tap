class Legionio < Formula
  ...
  on_arm do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.39-2/legion-1.9.39-2-darwin-arm64.tar.gz"
    sha256 "3f1030db9e0e97f5c270027aa9647a505c10ff3e553e4d8749ca73ce13e93af3"
  end

  on_intel do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.39-2/legion-1.9.39-2-darwin-x86_64.tar.gz"
    sha256 "4d1be3f8d20e59e66014a3c1d1a6048ef5fe5b3edadbc11b993e57ce08b844cc"
  end
  ...
  bottle do
    root_url "https://github.com/LegionIO/homebrew-tap/releases/download/bottles-legionio-1.9.39-1"
    sha256 cellar: :any, arm64_sequoia: "26376fbf5a6c1128d32a2acddf5c3e99449b0d4d8e5d41a15825e38a18f8c492"
    sha256 cellar: :any, arm64_sonoma: "e5c0cc95f1bf8119b73f9e363f3de1e61df6ec1b40bbbc2dd485a1741e8dd86e"
    sha256 cellar: :any, sequoia: "129d2da8c266c869baa4a4eedbc965c2cb3ba9f26757e8aa2ebc52a6d4b794ca"
  end
