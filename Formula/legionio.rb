class Legionio < Formula
  ...
  on_arm do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.39-6/legion-1.9.39-6-darwin-arm64.tar.gz"
    sha256 "b462a43a2287c19a6609cd0216f35ca01171c0414390e3f98d65b3d09e77a264"
  end

  on_intel do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.39-6/legion-1.9.39-6-darwin-x86_64.tar.gz"
    sha256 "ce923e50d9f79778b7f6bea20ca29b028aaa4e5f6c8f2dc09b38b7fdbcb45f75"
  end
  ...
  bottle do
    root_url "https://github.com/LegionIO/homebrew-tap/releases/download/bottles-legionio-1.9.39-6"
    sha256 cellar: :any, arm64_sequoia: "67117b58d694e2d93e2c8dd78646bea3fb58a636c02a9423483e0f42afa34c9e"
    sha256 cellar: :any, arm64_sonoma: "42f439ad4296f1039cea2b7d0b81695c052cae0df3075c38cacf19ced83350aa"
    sha256 cellar: :any, sequoia: "d998ce43a4e8d29f6d476dc77cd2d228927adb0ba01402ebcc291f5c9879f2c3"
  end
