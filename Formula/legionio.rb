class Legionio < Formula
  ...
  on_arm do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.37-1/legion-1.9.37-1-darwin-arm64.tar.gz"
    sha256 "c9ff15c47a2ac8bef7107a9361dfcaedd442e424fecbb13cda835c3a16625970"
  end

  on_intel do
    url "https://github.com/LegionIO/homebrew-tap/releases/download/legion-1.9.37-1/legion-1.9.37-1-darwin-x86_64.tar.gz"
    sha256 "81a6b0962a4204634b740a36c51ad7fa4003bcabd756bf745f0158dd9b1ce95d"
  end
  ...
  bottle do
    root_url "https://github.com/LegionIO/homebrew-tap/releases/download/bottles-legionio-1.9.37-1"
    sha256 cellar: :any, arm64_sequoia: "6f9c60fb5bc855eec5e23bcd06c5f3eecc5b8a6db5437407c30ef58c0153b260"
    sha256 cellar: :any, arm64_sonoma: "1dc913a2e76f963310333484e84f8a014fb234816a96d1f88bbfb7a11ea79a33"
    sha256 cellar: :any, sequoia: "43daee2867567d40c137f31b866b1eb2701b7c3c5aadb946011c19d423a26387"
  end
